...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{density_impact.pdf}
    \caption{Impact of Graph Density on Execution Time for 50k Graph.}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{cache_misses.pdf}
    \caption{Cache Miss Comparison (L1 Data and Last-Level) for the 50k Graph.}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{line_size_impact.pdf}
    \caption{Impact of Cache Line Size on L1 Data Misses for Pointer vs. CSR Layouts.}
    \label{fig:line_size_impact}
\end{figure}
